...
public:
    ...
    Q_PROPERTY(AIChatService*         aiChatService           READ    aiChatService           CONSTANT)
    ...
    AIChatService*          aiChatService       ()  { return _aiChatService; }
...
private:
    ...
    AIChatService*          _aiChatService          = nullptr;
